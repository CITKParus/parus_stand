create or replace procedure UDO_P_STAND_USER_ID
(
...
begin
  ...
  /* Идем по всем отмеченным записям контрагентов */
  ...
  loop
    ...
    /* Генерируем изображение QR-кода (встраиваем в код ссылку на сайт стенда) */
